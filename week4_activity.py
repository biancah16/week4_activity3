...
# index slicing is a way to get a substring froma a string
...
prepRally  = "Hancock Collage Prep cheerleaders are the best!"
...
#prints -1 because cheerleadersd is not in the text
